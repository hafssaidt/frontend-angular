    ...
    function diff_bisect_(text1, text2) {
      ...
      for (var d3 = 0; d3 < max_d; d3++) {
        ...
        for (var k22 = -d3 + k2start; k22 <= d3 - k2end; k22 += 2) {
          ...
          var x22;
          if (k22 === -d3 || k22 !== d3 && v2[k2_offset - 1] < v2[k2_offset + 1]) {
            x22 = v2[k2_offset + 1];
          } else {
...
// node_modules/parchment/dist/parchment.mjs
...
var l = ((a) => (a[a.TYPE = 3] = "TYPE", a[a.LEVEL = 12] = "LEVEL", a[a.ATTRIBUTE = 13] = "ATTRIBUTE", a[a.BLOT = 14] = "BLOT", a[a.INLINE = 7] = "INLINE", a[a.BLOCK = 11] = "BLOCK", a[a.BLOCK_BLOT = 10] = "BLOCK_BLOT", a[a.INLINE_BLOT = 6] = "INLINE_BLOT", a[a.BLOCK_ATTRIBUTE = 9] = "BLOCK_ATTRIBUTE", a[a.INLINE_ATTRIBUTE = 5] = "INLINE_ATTRIBUTE", a[a.ANY = 15] = "ANY", a))(l || {});
var b = class {
  constructor(t, e, s = {}) {
...
var g = class g2 {
  ...
  create(t, e, s) {
    ...
    return g2.blots.set(n.domNode, n), n;
  }
  find(t, e = false) {
    return g2.find(t, e);
  }
...
var Y = class extends b {
  ...
  add(t, e) {
    return this.canAdd(t, e) ? (t.style[x(this.keyName)] = e, true) : false;
  }
  remove(t) {
...
var k = class k2 {
  ...
  clone() {
    const t = this.domNode.cloneNode(false);
...
var f = class f2 extends C {
  ...
  attachUI(t) {
    this.uiNode != null && this.uiNode.remove(), this.uiNode = t, f2.uiClass && this.uiNode.classList.add(f2.uiClass), this.uiNode.setAttribute("contenteditable", "false"), this.domNode.insertBefore(this.uiNode, this.domNode.firstChild);
  }
  build() {
  ...
  descendant(t, e = 0) {
    ...
    return t.blotName == null && t(s) || t.blotName != null && s instanceof t ? [s, r] : s instanceof f2 ? s.descendant(t, r) : [null, -1];
  }
  descendants(t, e = 0, s = Number.MAX_VALUE) {
    ...
    return this.children.forEachAt(
      ...
      s,
      (h, n, o) => {
        (t.blotName == null && t(h) || t.blotName != null && h instanceof t) && r.push(h), h instanceof f2 && (r = r.concat(
          h.descendants(t, n, i)
        )), i -= o;
      }
    ), r;
  ...
  enforceAllowedChildren() {
    ...
    this.children.forEach((e) => {
      t || this.statics.allowedChildren.some(
        (r) => e instanceof r
      ) || (e.statics.scope === l.BLOCK_BLOT ? (e.next != null && this.splitAfter(e), e.prev != null && this.splitAfter(e.prev), e.parent.unwrap(), t = true) : e instanceof f2 ? e.unwrap() : e.remove());
    });
  }
  formatAt(t, e, s, r) {
  ...
  path(t, e = false) {
    ...
    return s instanceof f2 ? i.concat(s.path(r, e)) : (s != null && i.push([s, r]), i);
  }
  removeChild(t) {
  ...
  replaceWith(t, e) {
    const s = typeof t == "string" ? this.scroll.create(t, e) : t;
    return s instanceof f2 && this.moveChildren(s), super.replaceWith(s);
  }
  split(t, e = false) {
    if (!e) {
      if (t === 0)
...
var u = class u2 extends m {
  ...
  format(t, e) {
    if (t === this.statics.blotName && !e)
      this.children.forEach((s) => {
        s instanceof u2 || (s = s.wrap(u2.blotName, true)), this.attributes.copy(s);
      }), this.unwrap();
    else {
  ...
  optimize(t) {
    ...
    if (Object.keys(e).length === 0)
      return this.unwrap();
    const s = this.next;
    s instanceof u2 && s.prev === this && V(e, s.formats()) && (s.moveChildren(this), s.remove());
  }
  replaceWith(t, e) {
...
var d = class d2 extends m {
  ...
  format(t, e) {
    ...
    s != null && (s instanceof b ? this.attributes.attribute(s, e) : t === this.statics.blotName && !e ? this.replaceWith(d2.blotName) : e && (t !== this.statics.blotName || this.formats()[t] !== e) && this.replaceWith(t, e));
  }
  formats() {
    const t = this.attributes.values(), e = this.statics.formats(this.domNode, this.scroll);
    return e != null && (t[this.statics.blotName] = e), t;
...
var p = class p2 extends m {
  ...
  find(t, e = false) {
    ...
    return s ? s.scroll === this ? s : e ? this.find(s.scroll.domNode.parentNode, true) : null : null;
  }
  query(t, e = l.ANY) {
  ...
  optimize(t = [], e = {}) {
    ...
    for (let o = 0; n.length > 0; o += 1) {
      ...
      for (n.forEach((c) => {
        const v = this.find(c.target, true);
        v != null && (v.domNode === c.target && (c.type === "childList" ? (i(this.find(c.previousSibling, false)), Array.from(c.addedNodes).forEach((P) => {
          const w = this.find(P, false);
          i(w, false), w instanceof m && w.children.forEach((W) => {
            i(W, false);
          });
  ...
  update(t, e = {}) {
    ...
    t.map((r) => {
      const i = this.find(r.target, true);
...
var E = class E2 extends A {
  ...
  optimize(t) {
    super.optimize(t), this.text = this.statics.value(this.domNode), this.text.length === 0 ? this.remove() : this.next instanceof E2 && this.next.prev === this && (this.insertAt(this.length(), this.next.value()), this.next.remove());
  }
  position(t, e = false) {
...
var Inline = class _Inline extends O {
  static allowedChildren = [_Inline, break_default, X, Text2];
  ...
  formatAt(index, length, name, value) {
    if (_Inline.compare(this.statics.blotName, name) < 0 && this.scroll.query(name, l.BLOT)) {
...
var Block = class extends T {
  ...
  formatAt(index, length, name, value) {
    if (length <= 0)
      return;
    if (this.scroll.query(name, l.BLOCK)) {
...
Block.allowedChildren = [break_default, inline_default, X, Text2];
var BlockEmbed = class extends X {
  attach() {
    super.attach();
  ...
  format(name, value) {
    const attribute = this.scroll.query(name, l.BLOCK_ATTRIBUTE);
    if (attribute != null) {
...
BlockEmbed.scope = l.BLOCK_BLOT;
function blockDelta(blot) {
  let filter2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
  return blot.descendants(A).reduce((delta, leaf) => {
    if (leaf.length() === 0) {
      return delta;
    }
...
var Cursor = class _Cursor extends X {
  ...
  format(name, value) {
    ...
    let target = this;
    let index = 0;
    while (target != null && target.statics.scope !== l.BLOCK_BLOT) {
...
var Selection = class {
  ...
  format(format, value) {
    ...
    if (nativeRange == null || !nativeRange.native.collapsed || this.scroll.query(format, l.BLOCK))
      return;
    if (nativeRange.start.node !== this.cursor.textNode) {
      const blot = this.scroll.find(nativeRange.start.node, false);
      if (blot == null)
        return;
      if (blot instanceof A) {
      ...
      if (op.insert != null) {
        ...
        if (typeof op.insert === "string") {
          ...
          if (line instanceof Block) {
            const [leaf] = line.descendant(A, offset);
            if (leaf) {
          ...
          if (key == null)
            return index;
          const isInlineEmbed = this.scroll.query(key, l.INLINE) != null;
          if (isInlineEmbed) {
            if (scrollLength <= index || !!this.scroll.descendant(BlockEmbed, index)[0]) {
              isImplicitNewlineAppended = true;
            }
          } else if (index > 0) {
            const [leaf, offset] = this.scroll.descendant(A, index - 1);
            if (leaf instanceof Text2) {
              const text = leaf.value();
              if (text[offset] !== "\n") {
                isImplicitNewlinePrepended = true;
              }
            } else if (leaf instanceof X && leaf.statics.scope === l.INLINE_BLOT) {
              isImplicitNewlinePrepended = true;
            }
          }
          this.scroll.insertAt(index, key, op.insert[key]);
          if (isInlineEmbed) {
            const [leaf] = this.scroll.descendant(A, index);
            if (leaf) {
    ...
    if (length === 0) {
      this.scroll.path(index).forEach((path) => {
        ...
        if (blot instanceof Block) {
          lines.push(blot);
        } else if (blot instanceof A) {
          leaves.push(blot);
        }
      });
    } else {
      lines = this.scroll.lines(index, length);
      leaves = this.scroll.descendants(A, index, length);
    }
...
var Quill = class _Quill {
  ...
  static version = false ? "dev" : "2.0.0-rc.2";
  static imports = {
  ...
  constructor(container) {
    ...
    const scrollBlotName = z.blotName;
...
function expandConfig(container, userConfig) {
  let expandedConfig = merge_default({
    container,
    modules: {
      clipboard: true,
      keyboard: true,
  ...
  if (!expandedConfig.theme || expandedConfig.theme === Quill.DEFAULTS.theme) {
    expandedConfig.theme = theme_default;
  } else {
  ...
  const themeConfig = cloneDeep_default(expandedConfig.theme.DEFAULTS);
  [themeConfig, expandedConfig].forEach((config4) => {
    config4.modules = config4.modules || {};
    Object.keys(config4.modules).forEach((module2) => {
      if (config4.modules[module2] === true) {
        config4.modules[module2] = {};
      }
    });
  });
  const moduleNames = Object.keys(themeConfig.modules).concat(Object.keys(expandedConfig.modules));
  const moduleConfig = moduleNames.reduce((config4, name) => {
  ...
  expandedConfig = merge_default({}, Quill.DEFAULTS, {
  ...
  expandedConfig.modules = Object.keys(expandedConfig.modules).reduce((config4, name) => {
    if (expandedConfig.modules[name]) {
      config4[name] = expandedConfig.modules[name];
    }
    return config4;
  }, {});
...
var Scroll = class extends z {
  ...
  insertAt(index, value, def) {
    if (index >= this.length()) {
      if (def == null || this.scroll.query(value, l.BLOCK) == null) {
  ...
  insertBefore(blot, ref) {
    if (blot.statics.scope === l.INLINE_BLOT) {
  ...
  leaf(index) {
    ...
    return blot instanceof A ? [blot, offset] : [null, -1];
  }
  line(index) {
    if (index === this.length()) {
  ...
  createBlock(attributes, refBlot) {
    ...
    Object.entries(attributes).forEach((_ref3) => {
      let [key, value] = _ref3;
      const isBlockBlot = this.query(key, l.BLOCK & l.BLOT) != null;
      if (isBlockBlot) {
        blotName = key;
      } else {
        formats[key] = value;
  ...
  inlineContents.reduce((index2, op) => {
    ...
    if (op.insert != null) {
      if (typeof op.insert === "string") {
        ...
        const [leaf] = parent2.descendant(A, index2);
        ...
        const isInlineEmbed = parent2.scroll.query(key, l.INLINE) != null;
        if (isInlineEmbed) {
          const [leaf] = parent2.descendant(A, index2);
          const formats = bubbleFormats(leaf);
          attributes = import_quill_delta4.AttributeMap.diff(formats, attributes) || {};
...
var AlignAttribute = new b("align", "align", config);
var AlignClass = new K("align", "ql-align", config);
var AlignStyle = new Y("align", "text-align", config);

// node_modules/quill/formats/color.js
var ColorAttributor = class extends Y {
  value(domNode) {
...
var ColorClass = new K("color", "ql-color", {
  scope: l.INLINE
});
...
var BackgroundClass = new K("background", "ql-bg", {
  scope: l.INLINE
});
...
var DirectionAttribute = new b("direction", "dir", config2);
var DirectionClass = new K("direction", "ql-direction", config2);
var DirectionStyle = new Y("direction", "direction", config2);
...
var FontClass = new K("font", "ql-font", config3);
var FontStyleAttributor = class extends Y {
  value(node) {
...
var SizeClass = new K("size", "ql-size", {
  scope: l.INLINE,
  whitelist: ["small", "large", "huge"]
});
var SizeStyle = new Y("size", "font-size", {
  scope: l.INLINE,
...
var Keyboard = class _Keyboard extends module_default {
  ...
  listen() {
    this.quill.root.addEventListener("keydown", (evt) => {
      ...
      const prefixText = leafStart instanceof R ? leafStart.value().slice(0, offsetStart) : "";
      const suffixText = leafEnd instanceof R ? leafEnd.value().slice(offsetEnd) : "";
      const curContext = {
  ...
  handleEnter(range2, context) {
    const lineFormats = Object.keys(context.format).reduce((formats, format) => {
      if (this.quill.scroll.query(format, l.BLOCK) && !Array.isArray(context.format[format])) {
...
function isLine2(node, scroll) {
  ...
  if (match && match.prototype instanceof X)
    return false;
...
function matchAttributor(node, delta, scroll) {
  const attributes = b.keys(node);
  const classes = K.keys(node);
  const styles = Y.keys(node);
  const formats = {};
  attributes.concat(classes).concat(styles).forEach((name) => {
    let attr = scroll.query(name, l.ATTRIBUTE);
    if (attr != null) {
...
function matchBlot(node, delta, scroll) {
  ...
  if (match == null)
    return delta;
  if (match.prototype instanceof X) {
    const embed = {};
    ...
    if (match.prototype instanceof T && !deltaEndsWith(delta, "\n")) {
      delta.insert("\n");
    }
...
function endsWithNewlineChange(scroll, delta) {
  ...
  if (lastOp.attributes != null) {
    return Object.keys(lastOp.attributes).some((attr) => {
      return scroll.query(attr, l.BLOCK) != null;
    });
  }
  return false;
}
...
var import_quill_delta9 = __toESM(require_Delta());
  ...
  handleArrowKeys() {
    this.quill.keyboard.addBinding({
      ...
      handler(range2, _ref) {
        ...
        if (!(line instanceof m) || !line.uiNode) {
          return true;
        }
...
var IndentAttributor = class extends K {
  add(node, value) {
...
var import_quill_delta10 = __toESM(require_Delta());
var TokenAttributor = new K("code-token", "hljs", {
  scope: l.INLINE
});
...
var import_quill_delta11 = __toESM(require_Delta());
...
var import_quill_delta12 = __toESM(require_Delta());
  ...
  attach(input) {
    ...
    input.addEventListener(eventName, (e) => {
      ...
      if (this.handlers[format] != null) {
        ...
        // @ts-expect-error
        this.quill.scroll.query(format).prototype instanceof X
      ) {
    ...
    clean() {
      ...
      if (range2.length === 0) {
        ...
        Object.keys(formats).forEach((name) => {
          if (this.quill.scroll.query(name, l.INLINE) != null) {
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FP5ZWOO4.js.map
